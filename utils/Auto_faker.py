...
class RandomData:
    ...
    @classmethod
    def get_num(cls, zuo, you, hou):
        num = ''.join(str(random.sample(range(zuo, you), hou)))
        print(type(num))# 可以指定想要的随机数范围
        return num[1]


print(RandomData().random_name())
print(RandomData().random_mobile_phone_num())
print(RandomData().get_num(1, 4, 2))
print(RandomData().random_num())
# f.name() 生成姓名
# f.address() 生成地址
# city_suffix() 市/县
# country() 国家
